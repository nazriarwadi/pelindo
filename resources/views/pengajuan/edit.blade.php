...
@section('page_heading', 'Edit Pengajuan')
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="dark:text-white">Formulir Edit Pengajuan</h6>
                </div>
                        ...
                        <form action="{{ route('pengajuan.update', $pengajuan->id) }}" method="POST">
                            ...
                            <div class="flex flex-wrap -mx-3">
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="text" id="no_ppkb" name="no_ppkb"
                                        value="{{ old('no_ppkb', $pengajuan->no_ppkb) }}"
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="text" id="nama_kapal" name="nama_kapal"
                                        value="{{ old('nama_kapal', $pengajuan->nama_kapal) }}"
                                        class="text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none"
                                        required>
                                    @error('nama_kapal')
                                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="datetime-local" id="jam_masuk" name="jam_masuk"
                                        value="{{ old('jam_masuk', $pengajuan->jam_masuk->format('Y-m-d\TH:i')) }}"
                                        class="text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none"
                                        required>
                                    @error('jam_masuk')
                                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="datetime-local" id="jam_deploy" name="jam_deploy"
                                        value="{{ old('jam_deploy', $pengajuan->jam_deploy->format('Y-m-d\TH:i')) }}"
                                        class="text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none"
                                        required>
                                    @error('jam_deploy')
                                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="text" id="keterangan_from" name="keterangan_from"
                                        placeholder="e.g., Dermaga A"
                                        value="{{ old('keterangan_from', $pengajuan->keterangan_from) }}"
                                        class="text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none"
                                        required>
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6">
                                    ...
                                    <input type="text" id="keterangan_to" name="keterangan_to"
                                        placeholder="e.g., Dermaga B"
                                        value="{{ old('keterangan_to', $pengajuan->keterangan_to) }}"
                                        class="text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none"
                                        required>
                                    @error('keterangan_to')
                                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
